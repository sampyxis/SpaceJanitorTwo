...
kJump        = keyboard_check_pressed(ord("Z"))  || keyboard_check_pressed(ord("Y")) || keyboard_check_pressed(vk_space) || gamepad_button_check_pressed(0, gp_face1);
kJumpRelease = keyboard_check_released(ord("Z")) || keyboard_check_released(ord("Y")) || keyboard_check_released(vk_space) || gamepad_button_check_released(0, gp_face1);
